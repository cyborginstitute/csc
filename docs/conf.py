...
project = u'Cyborg Site Compiler'
...
html_title = 'Cyborg Site Compiler'
...
# (source start file, target name, title, author, documentclass [howto/manual]).
 ('index', 'csc.tex', u'Cyborg Site Compiler Manual', u'Sam Kleinman', 'howto'),
]
...
epub_title = u'Cyborg Site Compiler'
